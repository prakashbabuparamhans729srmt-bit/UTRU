      ...
      <div className="flex flex-col justify-center items-center p-8 relative">
        ...
        <div className="w-full max-w-md">
            ...
            <Button
                ...
                disabled={isPending}
            >
              {isPending ? <Loader2 className="animate-spin" /> : <><GoogleIcon /> Continue with Google</>}
            </Button>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <Button
                type="submit"
                className="w-full h-14 text-xl bg-teal-400 text-black hover:bg-teal-500 rounded-full font-bold shadow-teal-400/20 shadow-lg transition-transform active:scale-[0.98]"
                disabled={isPending}
                >
                {isPending ? (
            ...
            <Link href="/email-signup" className="font-bold text-teal-400 hover:underline">
                Sign up
            </Link>
            </p>
        </div>
