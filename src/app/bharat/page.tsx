    ...
    <div className="bg-background text-foreground min-h-screen flex flex-col">
      ...
      <main className="flex-grow pb-32">
            ...
            {navLinks.map(link => (
                <Link key={link.href} href={link.href} passHref>
                    <Button variant="ghost" className={cn(
                        ...
                        link.href === '/bharat' ? 'border-b-2 border-primary text-primary shadow-none' : 'text-muted-foreground'
                    )}>
                        {link.label}
                    </Button>
                </Link>
        ...
        <div className="p-4 text-center">
            <h1 className="text-2xl font-bold">Bharat Page</h1>
            <p className="text-muted-foreground">Content for Bharat will be displayed here.</p>
        </div>
