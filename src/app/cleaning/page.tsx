...
const cleaningServices = [
    { id: 'cleaning-deep-cleaning', name: 'Deep Home Cleaning' },
    { id: 'cleaning-pest-control', name: 'Pest Control' },
    { id: 'cleaning-sofa-cleaning', name: 'Sofa & Carpet Cleaning' },
    { id: 'cleaning-car-cleaning', name: 'Car Cleaning' },
];


export default function CleaningPage() {
  const router = useRouter();
  const heroImages = PlaceHolderImages.filter((img) => img.id.startsWith('cleaning-hero'));
